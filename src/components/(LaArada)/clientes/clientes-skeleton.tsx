  ...
  return (
    <div className="mx-auto w-full space-y-4 p-4 md:p-6 animate-in fade-in duration-200">
      ...
      <div className="mb-2 flex items-start justify-between gap-4">
        ...
        <div className="min-w-0 text-right">
          <div className="flex items-center justify-end gap-2">
            <Users className="size-5 text-blue-500/50" />
      ...
      <div className="space-y-2">
        ...
        <div className="overflow-hidden rounded-2xl border border-zinc-200 border-t-4 border-t-blue-600/40 bg-white shadow-sm dark:border-zinc-700 dark:border-t-blue-500/40 dark:bg-zinc-900">
          {/* Toolbar */}
            ...
            <table className="w-full text-xs md:text-sm text-left">
              <thead className="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-800/60">
                <tr>
                  ...
                  <th className="hidden md:table-cell px-4 py-3"><Skeleton className="h-3 w-20" /></th>
                  <th className="hidden sm:table-cell px-4 py-3"><Skeleton className="h-3 w-16" /></th>
                  <th className="hidden md:table-cell px-4 py-3"><Skeleton className="h-3 w-14" /></th>
              ...
              <tbody className="divide-y divide-zinc-100 dark:divide-zinc-700">
                {Array.from({ length: 7 }).map((_, i) => (
                  <tr key={i} className="animate-pulse">
                    ...
                    <td className="hidden md:table-cell px-4 py-3.5"><Skeleton className="h-4 w-48 rounded" /></td>
                    <td className="hidden sm:table-cell px-4 py-3.5"><Skeleton className="h-4 w-24 rounded" /></td>
                    <td className="hidden md:table-cell px-4 py-3.5"><Skeleton className="h-4 w-32 rounded" /></td>
