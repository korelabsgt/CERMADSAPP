...
export default function CreditosList({ clientes }: CreditosListProps) {
  ...
  if (clientes.length === 0) {
    return (
      <div className="rounded-xl border border-zinc-200 bg-white px-4 py-8 text-center text-sm font-bold text-zinc-500 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-400">
