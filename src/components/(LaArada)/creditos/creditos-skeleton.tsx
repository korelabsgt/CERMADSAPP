...
export function CreditosSkeleton() {
  return (
    <div className="mx-auto w-full space-y-4 p-4 md:p-6 animate-in fade-in duration-200">
      ...
      <div className="mb-2 flex items-start justify-between gap-4">
        ...
        <div className="min-w-0 text-right">
          <div className="flex items-center justify-end gap-2">
            <CreditCard className="size-5 text-red-500/50" />
      ...
      <div className="overflow-hidden rounded-2xl border border-zinc-200 border-t-4 border-t-red-600/40 bg-white shadow-sm dark:border-zinc-700 dark:border-t-red-500/40 dark:bg-zinc-900">
        {/* Toolbar */}
